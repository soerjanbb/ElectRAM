classdef SpanTest < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function verifySpan(testCase)
            ...
            comp  = lookup(model, Path="Electram/Wing");   % get the component
